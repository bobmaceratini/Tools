...
sigma0 = np.array([0.1*0, 0.2*0, -0.1*0])
#sigma0 = np.array([0.0, 0.0, 0.0])
#inital_W_BM_degps = np.array([0.0, 0.0, 0.0])
inital_W_BM_degps = np.array([300.0, 10.0*0, -20.0*0])
...
sigma,omega,angles,sigmaBR,u,z = EOM_Rotation_RMP_Integrator_KI(InertiaTensor,sigma0, omega0, t_eval,sigma_ref,omega_ref)
